...
import { useDecrementCartMutation, useIncrementCartMutation, useRemoveCartMutation } from "../../../../features/cart/cartApi";
                  ...
                  <div className="grid grid-cols-3 items-start gap-4">
                        <div className="col-span-2 flex items-start gap-4">
                              ...
                              <div className="flex flex-col">
                                    ...
                                    <button onClick={() => handleDelete(item?._id)} type="button" className="mt-6 font-semibold text-red-500 text-xs flex items-center gap-1 shrink-0">
                        ...
                        <div className="ml-auto">
                              ...
                              <button type="button"
                                    ...
                                    <svg onClick={() => decrementProduct(item?._id)} xmlns="http://www.w3.org/2000/svg" className="w-2.5 fill-current" viewBox="0 0 124 124">
                                          <path d="M112 50H12C5.4 50 0 55.4 0 62s5.4 12 12 12h100c6.6 0 12-5.4 12-12s-5.4-12-12-12z" data-original="#000000"></path>
                                    </svg>

                                    <span className="mx-3 font-bold">{item?.orderQuantity}</span>
                                    <svg onClick={() => incrementProduct(item?._id)} xmlns="http://www.w3.org/2000/svg" className="w-2.5 fill-current" viewBox="0 0 42 42">
